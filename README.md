...
# 📖 [React_ToDo_List] <a name="about-project"></a>

**[React_ToDo_List]** is an application built for recording todo list.
...
- [Live Demo Link](https://mudasiri.github.io//math-magicians/dist/)
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
- Clone the repository using the following command: git clone https://github.com/mudasiri/math-magicians
...
Feel free to check the [issues page](https://github.com/mudasiri/javascript-capstone/issues).
